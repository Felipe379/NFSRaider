...
namespace NFSRaider.Keys.MainKeys.Tracks.EventSequencers
{
    public class BuildEventSequencers : Builder
    {
        public override HashSet<string> GetKeys(Game? gameFilter = null, CancellationToken cancellationToken = default)
        {
            ...
            var eventSequencers = new HashSet<string>(FileRead.ReadFiles(files));

            return eventSequencers;
        }
    }
}
